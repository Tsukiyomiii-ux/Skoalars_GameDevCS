...
func _ready():
	...
	if hint_scroll:
		hint_scroll.pressed.connect(_on_hint_scroll_pressed)
...
func _on_button_hover(btn: TextureButton):
	if not is_transitioning: btn.modulate = Color(1.2, 1.2, 1.2)

func _on_button_exit(btn: TextureButton):
	if not is_transitioning: btn.modulate = Color.WHITE

# --- REDIRECT TO LEVEL 2 ---
func _on_next_button_pressed():
	GameManager.next_scene_path = "res://Assets/Scene/zypheria_lvl_2.tscn"
